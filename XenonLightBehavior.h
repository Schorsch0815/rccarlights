...
#ifndef XENONLIGHTBEHAVIOR_H_
#define XENONLIGHTBEHAVIOR_H_

#include "LightBehavior.h"

/**
 * class to change the bahaviour of the light switching and try to simulate a Xenon light, with flickering on startup
 * and slow cooldown.
 * The brightness characteristics of a xenon light will be generated by interpolating over few values when switching on
 * or off.
 */
class XenonLightBehavior : public LightBehavior
{
public:
    /**
     * constructor
     ...
     * destructor
     */
    virtual ~XenonLightBehavior();

    /**
     * This method implements the startup flickering and the cool down of a Xenon light. It has to be call from the main
     *loop and should
